 require('http').createServer((req,res)=>{res.writeHead(200);res.end("Morara Bot Active - Philip Wafula")}).listen(process.env.PORT||3000,()=>console.log("HTTP Server running"));
